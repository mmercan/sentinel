...
namespace Microsoft.AspNetCore.Builder
{
    ...
    /// </summary>
    public static class HealthCheckAuthApplicationBuilderExtensions
    {
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public static IApplicationBuilder UseHealthChecksWithAuth(this IApplicationBuilder app, PathString path)
        {
            if (app == null)
            {
            ...
            UseHealthChecksCore(app: app, path: path, port: null, args: Array.Empty<object>());
            return app;
        }
        ...
        /// </para>
        /// </remarks>
        public static IApplicationBuilder UseHealthChecksWithAuth(this IApplicationBuilder app, PathString path, int port)
        {
            if (app == null)
            {
                throw new ArgumentNullException(nameof(app));
        ...
        /// </para>
        /// </remarks>
        public static IApplicationBuilder UseHealthChecksWithAuth(this IApplicationBuilder app, PathString path, string port)
        {
            if (app == null)
            {
                throw new ArgumentNullException(nameof(app));
        ...
        /// </para>
        /// </remarks>
        public static IApplicationBuilder UseHealthChecksWithAuth(this IApplicationBuilder app, PathString path, int port, HealthCheckOptions options)
        {
            if (app == null)
            {
                throw new ArgumentNullException(nameof(app));
        ...
        private static void UseHealthChecksCore(IApplicationBuilder app, PathString path, int? port, object[] args)
        {
            ...
            app.MapWhen(predicate, b => b.UseMiddleware<HealthCheckMiddlewareAuth>(args));
        }
    }
}