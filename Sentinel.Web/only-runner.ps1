...
docker-compose.exe -f docker-compose-debug-linux_secrets.yml -f docker-compose-debug-linux.yml up sentinel-util-mailhog sentinel-db-redis sentinel-api-product sentinel-api-comms sentinel-api-member sentinel-handler-comms sentinel-handler-product sentinel-service-rabbitmq sentinel-ui-product sentinel-api-healthmonitoring
# missing services sentinel-ui-sts sentinel-util-kibana sentinel-service-nats sentinel-db-elasticsearch sentinel-ml-tensorflow sentinel-sql-db sentinel-db-mysql sentinel-ui-wordpress sentinel-api-billing sentinel-api-scheduler sentinel-api-shipping sentinel-db-mongodb 