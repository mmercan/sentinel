...
docker-compose -f docker-compose-prod-linux.yml up --build --force-recreate --renew-anon-volumes sentinel-db-redis sentinel-db-mongodb sentinel-nats sentinel-web-sts sentinel-web-api-product sentinel-web-api-comms  sentinel-web-admin
