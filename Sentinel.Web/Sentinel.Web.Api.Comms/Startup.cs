using System;
using Sentinel.Web.Api.Comms.Hubs;
...
// using Sentinel.Web.Api.Comms.DbContexts;
// using Sentinel.Web.Api.Comms.Repositories;
using Serilog;
...
namespace Sentinel.Web.Api.Comms
{
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                foreach (var description in provider.ApiVersionDescriptions)
                {
                    ...
                    new Info()
                    {
                        Title = $"Sentinel.Web.Api.Comms API {description.ApiVersion}",
