...
using AutoMapper;
// using Sentinel.Web.Api.Member.Models;
// using Sentinel.Web.Api.Member.DbContexts;
// using Sentinel.Web.Api.Member.Repositories;
using Serilog;
...
namespace Sentinel.Web.Api.Member
{
       ...
       .SetCompatibilityVersion(CompatibilityVersion.Version_2_1);
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                foreach (var description in provider.ApiVersionDescriptions)
                {
                    ...
                    new Info()
                    {
                        Title = $"Sentinel.Web.Api.Member API {description.ApiVersion}",
