...
export class HttpCallService {
  ...
  HttpCall(requestModel: IHttpCallRequestModel): Observable<any> {
    const obs = Observable.create(observer => {
      const apiurl = this.appConfig.config.Api.baseUrl + 'HttpCall/call';
      const postbody = JSON.stringify(requestModel);
      //   {
...
export interface IHttpCallRequestModel {
