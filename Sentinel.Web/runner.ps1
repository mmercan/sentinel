...
docker-compose -f docker-compose-debug-linux.yml up --build sentinel-util-mailhog sentinel-db-mongodb sentinel-service-nats sentinel-db-redis sentinel-ui-sts sentinel-api-product sentinel-api-comms sentinel-handler-comms sentinel-db-elasticsearch sentinel-util-kibana sentinel-service-rabbitmq sentinel-db-mysql sentinel-util-phpmyadmin sentinel-ui-wordpress sentinel-ui-orchard
