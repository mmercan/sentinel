...
{
    public class ProductV2ServerTests : IClassFixture<WebApplicationFactory<Sentinel.Api.Comms.Startup>>
    {
        private WebApplicationFactory<Startup> factory;
        private readonly ITestOutputHelper output;

        public ProductV2ServerTests(WebApplicationFactory<Sentinel.Api.Comms.Startup> factory, ITestOutputHelper output)
        {
