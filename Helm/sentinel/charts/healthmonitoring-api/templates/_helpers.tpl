...
*/}}
{{- define "Sentinel.Api.HealthMonitoring.name" -}}
...
*/}}
{{- define "Sentinel.Api.HealthMonitoring.fullname" -}}
...
*/}}
{{- define "Sentinel.Api.HealthMonitoring.chart" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}


{{- define "Sentinel.Api.HealthMonitoring.labels" -}}
helm.sh/chart: {{ include "Sentinel.Api.HealthMonitoring.chart" . }}
{{ include "Sentinel.Api.HealthMonitoring.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "Sentinel.Api.HealthMonitoring.selectorLabels" -}}
app: {{ include "Sentinel.Api.HealthMonitoring.name" . }}
version: {{ .Chart.AppVersion  | quote }}
app.kubernetes.io/name: {{ include "Sentinel.Api.HealthMonitoring.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
branch:  {{ .Values.branch }}
{{- end -}}

{{- define "Sentinel.Api.HealthMonitoring.annotations" -}}
...
{{- define "Sentinel.Api.HealthMonitoring.service.annotations" -}}
