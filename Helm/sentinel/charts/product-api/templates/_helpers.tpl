...
*/}}
{{- define "Sentinel.Api.Product.name" -}}
...
*/}}
{{- define "Sentinel.Api.Product.fullname" -}}
...
*/}}
{{- define "Sentinel.Api.Product.chart" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}



{{- define "Sentinel.Api.Product.labels" -}}
helm.sh/chart: {{ include "Sentinel.Api.Product.chart" . }}
{{ include "Sentinel.Api.Product.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "Sentinel.Api.Product.selectorLabels" -}}
app: {{ include "Sentinel.Api.Product.name" . }}
version: {{ .Chart.AppVersion  | quote }}
app.kubernetes.io/name: {{ include "Sentinel.Api.Product.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
branch:  {{ .Values.branch }}
{{- end -}}

{{- define "Sentinel.Api.Product.annotations" -}}
...
{{- define "Sentinel.Api.Product.service.annotations" -}}
...
{{- define "Sentinel.Api.Product.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "Sentinel.Api.Product.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
