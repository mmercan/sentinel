...
export class SigninbComponent implements OnInit, AfterViewInit {
  yeti: any = {};
  // caretPos = 0;
  // curEmailIndex = 0;
  // screenCenter = 0;
  ...
  constructor() { }
  ngAfterViewInit() {
    this.yeti.email = window.document.querySelector('#email');
    this.yeti.password = window.document.querySelector('#password');
    this.yeti.mySVG = document.querySelector('.svgContainer');
    this.yeti.armL = document.querySelector('.armL');
    this.yeti.armR = document.querySelector('.armR');
    this.yeti.eyeL = document.querySelector('.eyeL');
    this.yeti.eyeR = document.querySelector('.eyeR');
    this.yeti.nose = document.querySelector('.nose');
    this.yeti.mouth = document.querySelector('.mouth');
    this.yeti.mouthBG = document.querySelector('.mouthBG');
    this.yeti.mouthSmallBG = document.querySelector('.mouthSmallBG');
    this.yeti.mouthMediumBG = document.querySelector('.mouthMediumBG');
    this.yeti.mouthLargeBG = document.querySelector('.mouthLargeBG');
    this.yeti.mouthMaskPath = document.querySelector('#mouthMaskPath');
    this.yeti.mouthOutline = document.querySelector('.mouthOutline');
    this.yeti.tooth = document.querySelector('.tooth');
    this.yeti.tongue = document.querySelector('.tongue');
    this.yeti.chin = document.querySelector('.chin');
    this.yeti.face = document.querySelector('.face');
    this.yeti.eyebrow = document.querySelector('.eyebrow');
    this.yeti.outerEarL = document.querySelector('.earL .outerEar');
    this.yeti.outerEarR = document.querySelector('.earR .outerEar');
    this.yeti.earHairL = document.querySelector('.earL .earHair');
    this.yeti.earHairR = document.querySelector('.earR .earHair');
    this.yeti.hair = document.querySelector('.hair');
    console.log(this.yeti.armL.innerHTML);
    console.log(JSON.stringify(this.yeti));

    console.log(JSON.stringify(this.mySVG));
  }
  ...
  getCoord(e) {
    // var carPos = this.yeti.email.selectionEnd,
    //   div = document.createElement('div'),
    //   span = document.createElement('span'),
    //   copyStyle = getComputedStyle(email),
    // this.yeti.emailCoords = {};
    // this.yeti.caretCoords = {};
    // this.yeti.centerCoords = {};
    ...
    // div.textContent = this.yeti.email.value.substr(0, carPos);
    // span.textContent = this.yeti.email.value.substr(carPos) || '.';
    // div.appendChild(span);

    // this.yeti.emailCoords = this.getPosition(this.yeti.email);
    // // console.log("emailCoords.x: " + emailCoords.x + ", emailCoords.y: " + emailCoords.y);
    // this.yeti.caretCoords = this.getPosition(this.yeti.span);
    // // console.log("caretCoords.x " + caretCoords.x + ", caretCoords.y: " + caretCoords.y);
    // this.yeti.centerCoords = this.getPosition(this.yeti.mySVG);
    // // console.log("centerCoords.x: " + centerCoords.x);
    // this.yeti.svgCoords = this.getPosition(this.yeti.mySVG);
    // this.yeti.screenCenter = this.yeti.centerCoords.x + (this.yeti.mySVG.offsetWidth / 2);
    // // console.log("screenCenter: " + screenCenter);
    // this.yeti.caretPos = this.yeti.caretCoords.x + this.yeti.emailCoords.x;
    // // console.log("caretPos: " + caretPos);

    // this.yeti.dFromC = this.yeti.screenCenter - this.yeti.caretPos;
    // // console.log("dFromC: " + dFromC);
    // var pFromC = Math.round((this.yeti.caretPos / this.yeti.screenCenter) * 100) / 100;
    // if (pFromC < 1) {
    ...
    // var eyeLCoords = { x: this.yeti.svgCoords.x + 84, y: this.yeti.svgCoords.y + 76 };
    // var eyeRCoords = { x: this.yeti.svgCoords.x + 113, y: this.yeti.svgCoords.y + 76 };
    // var noseCoords = { x: this.yeti.svgCoords.x + 97, y: this.yeti.svgCoords.y + 81 };
    // var mouthCoords = { x: this.yeti.svgCoords.x + 100, y: this.yeti.svgCoords.y + 100 };
    // var eyeLAngle = this.getAngle(eyeLCoords.x, eyeLCoords.y, this.yeti.emailCoords.x + this.yeti.caretCoords.x, this.yeti.emailCoords.y + 25);
